...
public class AberrantControl : MonoBehaviour
{
    public float speed;
    ...
    public GameObject aberrantHealthContainer;
    ...
    void Start()
    {
        ...
        if (aberrantHealthContainer != null)
        {
            aberrantHealthContainer.SetActive(false);
        }
    }
    ...
    void Update()
    {
        ...
        {
            if (aberrantHealthContainer != null && !aberrantHealthContainer.activeSelf)
            {
                aberrantHealthContainer.SetActive(true);
    ...
    {
        // Check if the player is to the left or right of the Aberrant
